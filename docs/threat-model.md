...
| Installer supply chain | The easy installer downloads one versioned standalone application from this repository's GitHub release. CI builds and executes every operating-system artifact. Inspect the short installer first if your environment forbids downloaded executables. |
